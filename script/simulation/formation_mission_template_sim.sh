...
--tab -e 'bash -c "sleep 6; roslaunch px4_application app_uav_mission_template.launch uav_id:=1; exec bash"' \
...
--tab -e 'bash -c "sleep 6; roslaunch px4_application app_uav_mission_template.launch uav_id:=2; exec bash"' \
...
--tab -e 'bash -c "sleep 6; roslaunch px4_application app_uav_mission_template.launch uav_id:=3; exec bash"' \
...
--tab -e 'bash -c "sleep 6; roslaunch px4_application app_uav_mission_template.launch uav_id:=4; exec bash"' \
...
--tab -e 'bash -c "sleep 6; roslaunch px4_application app_uav_mission_template.launch uav_id:=5; exec bash"' \
